        ...
        <div className="relative w-full overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center pt-[5%] text-center">
                <div className="flex flex-col gap-10 items-center text-center">
                    ...
                    <button onClick={() => navigate('/daftar')} className="bg-rpl-blue-400 w-90 h-15 rounded-xl text-white font-bold text-4xl border-[#FFFFFF] border-2">Daftar Sekarang!</button>
            ...
            <div className="absolute bottom-0 left-0 w-full z-20 flex justify-end p-5">
                <button onClick={() => navigate('/login')} className="bg-white w-30 h-10 rounded-xl text-rpl-blue-500 font-bold text-2xl flex-row flex px-5 py-1">login <img src={ArrowUp} alt="arrow" className="w-5 h-5 mt-2" /></button>
            </div>
        </div>
    )
}
