        ...
        <div className="bg-gray-100 min-h-screen flex items-center justify-center p-6">
            <div className="bg-white p-8 md:p-12 rounded-3xl shadow-2xl text-center max-w-lg w-full border-t-8 border-green-500 relative overflow-hidden">
                ...
                <div className="bg-gray-50 rounded-xl p-6 mb-8 border border-gray-100 relative z-10">
                    ...
                    <p className="text-2xl font-mono font-bold text-indigo-600 bg-indigo-50 py-2 rounded-lg border border-indigo-100">
                        {noPendaftaran}
                    </p>
                ...
                <Link to="/" className="inline-block w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-xl transition-all shadow-lg shadow-indigo-200 relative z-10">
