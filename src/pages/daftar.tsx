...
export default function Daftar() {
    return (
        <div className="w-full h-screen bg-white">
            <div className="h-screen w-1/2 absolute">
                <img src={backgroundSekolah} alt="backgroundSekolah" className="w-full h-full object-cover" />
                <img src={person} alt="person" className="left-30 absolute top-0 h-screen object-contain" />
            </div>
            <div className="h-screen w-1/2 absolute right-0 top-0 absolute">
                <div className="w-full h-[90%] flex flex-col items-center absolute top-10 gap-5">
                    ...
                    <div className="w-[80%] flex flex-col gap-5">
                        ...
                        <div className="flex flex-row gap-10">
                            <div className="w-full">
                                <label htmlFor="TanggalLahir" className="text-[#005695] font-medium text-lg">Tempat, Tanggal Lahir</label>
                        ...
                        <div className="flex flex-row gap-10">
                            ...
                            <div className="w-full">
                                <label htmlFor="jenisKelamin" className="text-[#005695] font-medium text-lg">Jenis Kelamin</label>
                                <select id="jenisKelamin" className="text-m w-full border border-[#004EDF] h-9 focus:outline-none border-2 rounded-xl px-3">
                        ...
                        <div className="flex flex-row gap-10">
                            <div className="w-full">
                                <label htmlFor="SekolahAsal" className="text-[#005695] font-medium text-lg">Sekolah Asal</label>
                                <input type="text" id="SekolahAsal" placeholder="Ketik" className="w-full border border-[#004EDF] h-9 focus:outline-none border-2 rounded-xl px-3 py-2" />
                            </div>
                            <div className="w-full">
